...
namespace utf {
	std::string encodeAsUTF8(const char* data, const size_t size);
	std::string encodeAsUTF8(const char16_t* data, const size_t size);
	std::string encodeAsUTF8(const char32_t* data, const size_t size);
